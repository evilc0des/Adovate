...
export const mockReport: Report = {
    ...
    analysisTimestamp: { _seconds: Math.floor(new Date("2022-01-01T00:00:00Z").getTime() / 1000) },
    uploadTimestamp: { _seconds: Math.floor(new Date("2022-01-01T00:00:00Z").getTime() / 1000) },
